...
bool actualLedState = false;  // המצב הפיזי האחרון שדווח ל-ESP32 (לסנכרון כפתור באפליקציה)
...
void updateLedLogic() {
  ...
  // אם המצב הפיזי של הלד השתנה (בין אם מהמתג, מהאפליקציה, או
  // אוטומטית לפי טמפ'), נדווח ל-ESP32 כדי שהאפליקציה תוכל
  // לסנכרן את צבע הכפתור עם המצב האמיתי של הלד.
